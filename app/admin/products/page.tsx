...
export default function AdminProductsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tambah Produk + Status Filter — sejajar */}
      <div className="flex items-center gap-2">
        <button
          onClick={() => router.push('/admin/products/new')}
          className="inline-flex items-center gap-1.5 px-3.5 sm:px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors whitespace-nowrap"
        >
        ...
        <div className="relative">
          ...
          {showStatusFilter && (
            <>
              ...
              <div className="absolute left-0 sm:right-0 top-full mt-1 z-20 w-44 sm:w-48 bg-white rounded-lg border border-gray-200 shadow-lg">
